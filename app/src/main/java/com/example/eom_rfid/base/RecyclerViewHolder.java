...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public ConstraintLayout getConstraintLayout(int viewId) {
        ConstraintLayout view = (ConstraintLayout) mViews.get(viewId);
        if (view == null) {
            view = (ConstraintLayout) itemView.findViewById(viewId);
            mViews.put(viewId, view);
        }
        return view;
    }
    ...
    public RelativeLayout getRelativeLayout(int viewId) {
        RelativeLayout view = (RelativeLayout) mViews.get(viewId);
        if (view == null) {
            view = (RelativeLayout ) itemView.findViewById(viewId);
            mViews.put(viewId, view);
        }
        return view;
    }
     ...
     * @return
     */
    public ImageView setImageView(int viewId, Drawable resId) {
        ImageView view = (ImageView) mViews.get(viewId);
        if (view == null) {
            view = (ImageView) itemView.findViewById(viewId);
            mViews.put(viewId, view);
