...
public final class ToastUtil {
    ...
    public static void showSucceedTipToast(Context context, String message) {
        SingleToast.getInstance().toast(0, message);
    }

    public static void showFailedTipToast(Context context, String message) {
        SingleToast.getInstance().toast(1, message);
    }

    public static void showLoadingTipToast(Context context, String message) {
        SingleToast.getInstance().toast(10000, message);
    }
}